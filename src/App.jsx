  ...
  return (
    <div className="App">
      ...
      <div class="right-container">
        {
          cards.magicCards.map((c) => { return <Card key={c.cardName} cardName={c.cardName} cardDescription={c.cardDescription} cardImage={c.cardImage} cardLink={c.cardLink}></Card> })
        }
      </div>
